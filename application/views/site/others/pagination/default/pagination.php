	...
	<?php if ( $cp > 1 ) { ?>
	<a class="button" href="<?php echo get_url(str_replace(array('%p%', '%ipp%'), array($cp-1, $ipp), $uri)); ?>"><?php echo lang('previous_page'); ?></a>
	<?php } else { ?>
	<span class="button inactive current"><?php echo lang('previous_page'); ?></span>
	<?php } ?>
	...
	<?php if ( $cp < $tp ) { ?>
	<a class="button" href="<?php echo get_url(str_replace(array('%p%', '%ipp%'), array($cp+1, $ipp), $uri)); ?>"><?php echo lang('next_page'); ?></a>
	<?php } else { ?>
	<span class="button inactive current"><?php echo lang('next_page'); ?></span>
	<?php } ?>