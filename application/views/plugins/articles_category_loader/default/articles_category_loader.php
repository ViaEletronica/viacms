			...
			<article class="s1 inner item">
				...
				<?php
					...
					$thumb_params = array(
						...
						'wrapper_class' => 'article-image-wrapper',
						'src' => $article[ 'image' ],
						'href' => ! check_var( $plugin_params[ 'show_image_as_link_on_list_view' ] ) ? FALSE : ( ( check_var( $plugin_params[ 'list_view_image_link_mode' ] ) AND $plugin_params[ 'list_view_image_link_mode' ] == 'link_to_image' ) ? $article[ 'image' ] : $article[ 'url' ] ),
						'rel' => ! check_var( $plugin_params[ 'show_image_as_link_on_list_view' ] ) ? FALSE : ( ( check_var( $plugin_params[ 'list_view_image_link_mode' ] ) AND $plugin_params[ 'list_view_image_link_mode' ] == 'link_to_image' ) ? 'article-thumb' : FALSE ),
						'title' => $article[ 'title' ],
	...
	<div class="read-more category-read-more-link-wrapper">
		...
		<div class="s1 inner">
			...
			<div class="s2 inner">
				...
				<a class="read-more-link category-read-more-link" href="<?= $category[ 'url' ]; ?>" <?= element_title( $plugin_params[ 'readmore_text' ] ); ?> ><?= $plugin_params[ 'readmore_text' ]; ?></a>
