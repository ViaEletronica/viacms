...
<?php
	...
	$date_issue_time = ( @$tender[ 'date_issue' ] ) ? strtotime( $tender[ 'date_issue' ] ) : gmt_to_local( now(), $this->mcm->filtered_system_params[ 'time_zone' ], TRUE );
	$date_issue = $this->input->post( 'date_issue' ) ? $this->input->post( 'date_issue' ) : strftime( '%Y-%m-%d', $date_issue_time );
	
	$date_tender_order_time = ( @$tender[ 'date_tender_order' ] ) ? strtotime( $tender[ 'date_tender_order' ] ) : gmt_to_local( now(), $this->mcm->filtered_system_params[ 'time_zone' ], TRUE );
