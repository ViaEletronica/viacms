					...
					<fieldset id="submit-form-fields">
						...
						<div class="fields-fields-wrapper">
							...
							<div class="vui-field-wrapper-inline">
								...
								<?= vui_el_button( array( 'id' => 'submit-add-field-' . $key, 'button_type' => 'button', 'name' => 'submit_remove_field[' . $key . ']', 'class' => 'btn btn-delete', 'title' => lang( 'tip_remove_field' ), 'text' => lang( 'remove_field' ), 'icon' => 'remove',  ) ); ?>
