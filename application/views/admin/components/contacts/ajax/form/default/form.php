<?php
	...
	$created_date_time = ( check_var( $contact[ 'birthday_date' ] ) ) ? strtotime( $contact[ 'birthday_date' ] ) : gmt_to_local( now(), $this->mcm->filtered_system_params[ 'time_zone' ] );
	...
	$contact[ 'birthday_date' ] = ( check_var( $contact[ 'birthday_date' ] ) ) ? strtotime( $contact[ 'birthday_date' ] ) : gmt_to_local( now(), $this->mcm->filtered_system_params[ 'time_zone' ] );
