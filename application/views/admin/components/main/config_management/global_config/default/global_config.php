...
<div id="global-config-form-wrapper" class="form-wrapper tabs-wrapper">
	...
	<div class="form-wrapper-sub tabs-children">
		...
		<?php echo form_open( get_url( 'admin' . $this->uri->ruri_string() ), array( 'id' => 'global-config-form' ) ); ?>
			
			<div class="form-actions to-toolbar">
				
				<?= vui_el_button( array( 'text' => lang( 'action_save' ), 'icon' => 'save', 'button_type' => 'button', 'type' => 'submit', 'name' => 'submit', 'id' => 'submit', 'only_icon' => TRUE, 'form' => 'global-config-form', ) ); ?>
				
				<?= vui_el_button( array( 'text' => lang( 'action_apply' ), 'icon' => 'apply', 'button_type' => 'button', 'type' => 'submit', 'name' => 'submit_apply', 'id' => 'submit-apply', 'only_icon' => TRUE, 'form' => 'global-config-form', ) ); ?>
				
				<?= vui_el_button( array( 'text' => lang( 'action_cancel' ), 'icon' => 'cancel', 'button_type' => 'button', 'type' => 'submit', 'name' => 'submit_cancel', 'id' => 'submit-cancel', 'only_icon' => TRUE, 'form' => 'global-config-form', ) ); ?>
				
			</div>
			
			<header class="form-header tabs-header">
				
				<h1><?= lang( 'main_global_config' ); ?></h1>
