...
<script type="text/javascript">
	...
	$( document ).on( 'mousedown focus', '.date', function(event) {
		...
		$( this ).datepicker({
			...
			onSelect: function() {
				...
				if ( $( this ).data( 'on-select-callback-function' ) ){
					
					window[ $( this ).data( 'on-select-callback-function' ) ]();
					console.log( '[jQuery UI][Datepicker] calling on select callback function ' + $( this ).data( 'on-select-callback-function' ) );
					
				}
				else {
					
					$( this ).change();
					console.log( '[jQuery UI][Datepicker] Change event triggered from onSelect datepicker event' )
