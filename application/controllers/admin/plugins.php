...
class Plugins extends Main {
	...
	public function __construct(){
		...
		if ( ! $this->users_common_model->check_privileges('plugins_management') ){
	...
	public function pm(){
		...
		if ( $action == 'pl' OR $action == 's' ){
			...
			if ( ! ( ( $order_by_direction = $this->users_common_model->get_user_preference( 'plugins_list_order_by_direction' ) ) != FALSE ) ){
			...
			if ( ( $order_by = $this->users_common_model->get_user_preference( 'plugins_list_order_by' ) ) != FALSE ){
		 ...
		 */
			...
			$this->users_common_model->set_user_preferences( array( 'plugins_list_order_by' => $ob ) );
			...
			if ( ( $order_by_direction = $this->users_common_model->get_user_preference( 'plugins_list_order_by_direction' ) ) != FALSE ){
				...
				$this->users_common_model->set_user_preferences( array( 'plugins_list_order_by_direction' => $order_by_direction ) );
				
			}
			else {
				
				$this->users_common_model->set_user_preferences( array( 'plugins_list_order_by_direction' => 'ASC' ) );
