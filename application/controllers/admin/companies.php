...
class Companies extends Main {
	...
	public function companies_management( $action = NULL, $var1 = NULL, $var2 = NULL, $var3 = NULL, $var4 = NULL, $var5 = NULL, $var6 = NULL ){
		...
		if ( $action == 'companies_list' OR $action == 'search' ){
			...
			if ( ! ( ( $order_by_direction = $this->users_common_model->get_user_preference( 'companies_order_by_direction' ) ) != FALSE ) ){
			...
			if ( ( $order_by = $this->users_common_model->get_user_preference( 'companies_order_by' ) ) != FALSE ){
		...
		/***************** Change order by ****************/
			...
			$this->users_common_model->set_user_preferences( array( 'companies_order_by' => $var1 ) );
			...
			if ( ( $order_by_direction = $this->users_common_model->get_user_preference( 'companies_order_by_direction' ) ) != FALSE ){
				...
				$this->users_common_model->set_user_preferences( array( 'companies_order_by_direction' => $order_by_direction ) );
				
			}
			else {
				
				$this->users_common_model->set_user_preferences( array( 'companies_order_by_direction' => 'ASC' ) );
