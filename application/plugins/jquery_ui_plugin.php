	...
	public function run( &$data, $params = NULL ){
		...
		if ( parent::_performed( 'jquery' ) ){
			...
			if ( JS_JQUERY_UI_LOAD_ALL_COMPONENTS ) {
				...
				$this->voutput->append_head_stylesheet( 'jquery_ui', JS_JQUERY_UI_CSS_URL . '/base/jquery.ui.all.css' );
			...
			$this->voutput->append_head_script_declaration( 'jquery_ui', $this->load->view( 'admin/plugins/jquery_ui/default/jquery_ui', NULL, TRUE ), NULL, NULL );
