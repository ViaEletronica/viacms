...
class Jquery_ui_timepicker_plugin extends Plugins_mdl{
	...
	public function run( &$data, $params = NULL ){
		...
		if ( parent::_performed( 'jquery_ui' ) ){
			...
			$this->voutput->append_head_script_declaration( 'jquery_ui_timepicker', $this->load->view( 'admin/plugins/jquery_ui_timepicker/default/jquery_ui_timepicker', NULL, TRUE ), NULL, NULL );
