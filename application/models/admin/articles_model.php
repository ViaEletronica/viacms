	...
	class Articles_model extends CI_Model{
		...
		public function menu_item_article_detail(){
			...
			foreach ($query as $article) {
				$articles_options[$article->id] = $article->title;
			}
		...
		public function menu_item_articles_list( $menu_item = NULL ){
			...
			$spec_options = isset( $params[ 'params_spec' ][ 'articles_list' ][ 'category_id' ][ 'options' ] ) ? $params[ 'params_spec' ][ 'articles_list' ][ 'category_id' ][ 'options' ] : array();
			$params[ 'params_spec' ][ 'articles_list' ][ 'category_id' ][ 'options' ] = $spec_options + $categories_options;
			...
			//echo '<pre>' . print_r( $layout_params, TRUE ) . '</pre>';exit;
		...
		private function _get_articles_list_layout_params( $menu_item, $params_spec_values ) {
			...
			$order_by_options = $component_params_spec[ 'params_spec' ][ 'articles_list' ][ 'articles_list_order' ][ 'options' ];
