<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Articles_model extends CI_Model{
		...
		public function menu_item_articles_list(){
			...
			foreach ( $params['params_spec']['articles_list'] as $key => $element ) {
				...
				if ( $element['name'] == 'category_id' ){
					...
					$params['params_spec']['articles_list'][$key]['options'] = is_array($spec_options) ? $spec_options + $categories_options : $categories_options;
