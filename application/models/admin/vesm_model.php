<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Vesm_model extends CI_Model{
		...
		public function generate_tender_pdf( $filename = NULL, $data = NULL, $destination = 'F', $layout = 'default' ){
			...
			else if ( file_exists( VIEWS_PATH . ADMIN_COMPONENTS_VIEWS_PATH . DS . get_class_name( get_class() ) . DS . 'tenders_management' . DS . 'tender_pdf' . DS . $layout . DS . 'tender_pdf.php' ) ){
				
				$view = $this->load->view( ADMIN_COMPONENTS_VIEWS_PATH . DS . get_class_name( get_class() ) . DS . 'tenders_management' . DS . 'tender_pdf' . DS . $layout . DS . 'tender_pdf', $data, TRUE);
